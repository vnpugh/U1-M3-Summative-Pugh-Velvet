...
public Controller() {
    ...
    EightBall.add(new EightBall(null, "Your love life is a hot mess!"));
...
//    public EightBall EightBall(@RequestBody String question) {
...
//    public EightBall EightBall(@RequestBody EightBall eightBall) {
//
//        Random random = new Random();
//        int x = random.nextInt(EightBall.size());
////        this.EightBall.get(x).setQuestion(question);
////        return this.EightBall.get(x);
////        EightBall.save(eightBall);
//
//        return eightBall;
        ...
        public Quote Quote(@RequestBody String question) {
        //public List<Quote> getQuote() {
            Random Random = new Random();
            int x = Random.nextInt(Quote.size());

//            this.Quote.get(x).setQuote(Quote);
//            return this.Quote;
    ...
    public List<Word> getWord() {
        return this.Word;                      //NEED RESPONSE BODY = DEFINITION
    }
